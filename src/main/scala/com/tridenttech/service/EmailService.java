...
public class EmailService {
	...
	private static List<String> clientInfoList = Arrays.asList("deokishore@yahoo.com","navjit20@hotmail.com","saikat.mitra@outlook.com","i.abbas@live.com");
	...
	public void sendClientEMail(final ClientInformationForm clientInformationForm)
			...
			preparators[i++] = new MimeMessagePreparator() {
				public void prepare(MimeMessage mimeMessage) throws Exception {
					try {
						...
						message.setFrom("customercare@tamaarskincare.com", "Tamaar Skin Care");
		...
		if(clientInformationForm.getEmail() != null) {
			...
			message.setSubject(" Tamaar Skin Care -  Customer Care");
			try {
				message.setFrom("customercare@tamaarskincare.com", " Tamaar Skin Care  -  Customer Care");
