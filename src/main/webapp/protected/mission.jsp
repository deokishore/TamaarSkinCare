    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            <div class="carousel-inner">
				<img src="/resources/images/mission.jpg" alt="Vision" width="100%">
			 </div><!--/.carousel-inner-->
        </div><!--/.carousel-->
    </section><!--/#main-slider-->
    ...
    <section id="vision">
        <div class="container">
        	<div class="col-md-8 col-sm-6">
                ...
                <p class="lead textjustify">We understand that the industry that we belong to is subjected to rapid changes that have to be dedicatedly kept up with. The requirement for the aforesaid simply being, keeping our team well acquainted with ever changing market strategies and technicalities that will help them understand the nuances of providing our clients exactly what they need in complete harmonization with the scenario.</p>
